package com.myapp.groceryshopcustomer.Service;
...
import com.myapp.groceryshopcustomer.Activity.GetLocationActivity;
import com.myapp.groceryshopcustomer.Activity.MainActivity;
...
public class MyFirebaseMessagingService  extends FirebaseMessagingService {
    ...
    private void handleNotification(String message) {
        ...
        showNotification("Grocery Shop Customer", message, message);
    ...
    private void handleDataMessage(JSONObject json) {
        ...
        try {
            ...
            if (!NotificationUtils.isAppIsInBackground(getApplicationContext())) {
                ...
                Intent resultIntent = new Intent(getApplicationContext(), GetLocationActivity.class);
