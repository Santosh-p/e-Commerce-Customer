...
public class CartDetailsListAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public CartDetailsListAdapter(Context context, int textViewResourceId,
    ...
    static class ViewHolder {
        Cart cart;
        TextView txtproductname, txtManufacturar, txtCategory, txtprice, txtmrp, txtquantity, txtUnit, txtTotalPrice;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        vi = v.inflate(R.layout.cart_list_item, null);
        ...
        holder.txtmrp.setText(String.valueOf(post.getMrp()));
