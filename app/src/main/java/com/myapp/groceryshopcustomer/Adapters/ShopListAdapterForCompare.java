...
import com.myapp.groceryshopcustomer.Activity.CompareActivity;
 ...
 */
public class ShopListAdapterForCompare extends BaseAdapter implements View.OnClickListener {
    ...
    public ShopListAdapterForCompare(Context context, int textViewResourceId,
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        vi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
               ...
               // editor.putInt("midToComp",mId);
                editor.putString("shopNameToComp",merchant.getShopName());
                editor.apply();
                Intent selectCategoryIntent=new Intent(myContext,CompareActivity.class);
